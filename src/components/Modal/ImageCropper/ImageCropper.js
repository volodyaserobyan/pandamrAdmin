...
const ImageCropper = (props) => {
  return (
    <div className="global-holder image-crop-holder">
      <div className="image-crop-cont">
        ...
        <div className="image-crop-dimensions">
          ...
          <button className="dimension-button dimension-selected">
            1200 <span>&times;</span> 628px
          </button>
          <button className="dimension-button dimension-selectable">
            1200 <span>&times;</span> 600px
          </button>
        </div>
